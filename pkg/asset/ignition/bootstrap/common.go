...
func (a *Common) generateConfig(dependencies asset.Parents, templateData *bootstrapTemplateData) error {
	...
	if err := a.addSystemdUnits("bootstrap/systemd/units", templateData); err != nil {
		return err
	}
...
func (a *Common) addSystemdUnits(uri string, templateData *bootstrapTemplateData) (err error) {
